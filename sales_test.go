...
func Test_Sales_SalesReportsResource_GetReports_InvalidFilter(t *testing.T) {
	...
	resp, err := resource.GetReports(ctx, filter)
	assert.Nil(t, resp)
	assert.Error(t, err)
...
func Test_Sales_SalesReportsResource_GetReports_Success(t *testing.T) {
	httpmock.Activate()
...
func Test_Sales_SalesReportsResource_GetSalesReports_Success(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetSalesReports_Error(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetSubscriptionsReports_Error(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetSubscriptionsEventsReports_Success(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetSubscriptionsEventsReports_Error(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetSubscribersReports_Success(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetSubscribersReports_Error(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetPreOrdersReports_Success(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
...
func Test_Sales_SalesReportsResource_GetPreOrdersReports_Error(t *testing.T) {
	httpmock.Activate()
	defer httpmock.DeactivateAndReset()
